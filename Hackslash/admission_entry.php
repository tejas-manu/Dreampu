...
('$Identity_Proof','$Identity_Number','$Full_Name','$Age','$Gender','$Father_Name','$Mother_Name','$Father_Occupation','$Mother_Occupation','$Income','$Field','$Science_Course','$Commerce_Course','$Class_10_percentage','$Contact_Number','$Alternate_Number','$House_Address','$Nationality','$Email_Address')";
    ...
    if ($Field === "science" )
    {
            $sql_query1 = "INSERT INTO science (Application_ID,Full_Name,Father_Name,Field,Science_Course,Class_10_percentage)VALUES

            ('$Identity_Number','$Full_Name','$Father_Name','$Field','$Science_Course','$Class_10_percentage') ";
            
    }
    else
    {

        $sql_query1 = "INSERT INTO commerce (Application_ID,Full_Name,Father_Name,Field,Commerce_Course,Class_10_percentage)VALUES

        ('$Identity_Number','$Full_Name','$Father_Name','$Field','$Commerce_Course','$Class_10_percentage') ";
    }
